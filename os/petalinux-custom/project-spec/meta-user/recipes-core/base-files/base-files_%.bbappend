...
do_install:append(){
    ...
    echo "/dev/mmcblk0p1       /mnt/emmc          auto       defaults,sync,auto,nofail  0  0" >> ${D}${sysconfdir}/fstab

    echo "/dev/mmcblk1p1       /mnt/sd          auto       defaults,sync,auto,nofail  0  0" >> ${D}${sysconfdir}/fstab
