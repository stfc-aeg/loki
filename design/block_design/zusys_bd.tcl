catch {TE::UTILS::te_msg TE_BD-0 INFO "This block design tcl-file was generate with Trenz Electronic GmbH Board Part:trenz.biz:te0803_4cg_1e_tebf0808:part0:2.0, FPGA: xczu4cg-sfvc784-1-e at 2020-10-29T16:53:01."}
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__ACT_FREQMHZ {1.000000} \
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__DIVISOR0 {50} \
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__DIVISOR1 {15} \
   CONFIG.PSU__CRL_APB__SPI0_REF_CTRL__FREQMHZ {1} \
