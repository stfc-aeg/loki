 ...
 u32 TE_XFsbl_TPSU_MODIFIED(void)
{
  ...
  xil_printf("Configure Carrier I2C Switch 0x72\r\n");
  Status = iic_write8(0x72, 0x00,  0x10);    // Configure I2C Switch
  if (Status != XFSBL_SUCCESS) {
     xil_printf("Error: Configure TEBF0808 I2C Switch 0x72 for TE0803 SI5338 access\r\n");
     goto END;
  }
