catch {TE::UTILS::te_msg TE_BD-0 INFO "This block design tcl-file was generate with Trenz Electronic GmbH Board Part:trenz.biz:te0803_4cg_1e_tebf0808:part0:2.0, FPGA: xczu4cg-sfvc784-1-e at 2025-07-01T10:51:02."}
...
proc create_hier_cell_RGPIO { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_RGPIO() - Empty argument(s)!"}
     return
  }
  ...
  set_property CONFIG.C_TYP {0} $RGPIO_Master_CPLD
  ...
  set_property CONFIG.C_TYP {0} $RGPIO_Slave_CPLD
  ...
  connect_bd_net -net vio_rgpio_m_11dt8_MUX [get_bd_pins xlslice_10/Dout] [get_bd_pins vio_rgpio/probe_in10]
  connect_bd_net -net vio_rgpio_m_11dt8_muxsel [get_bd_pins vio_rgpio/probe_out3] [get_bd_pins xlconcat_2/In2]
  connect_bd_net -net vio_rgpio_m_12_CAN_FAULT [get_bd_pins xlslice_9/Dout] [get_bd_pins vio_rgpio/probe_in9]
  connect_bd_net -net vio_rgpio_m_15dt13_PHY_LEDS [get_bd_pins xlslice_8/Dout] [get_bd_pins vio_rgpio/probe_in8]
  connect_bd_net -net vio_rgpio_m_16_XMOD2BUTTON [get_bd_pins xlslice_7/Dout] [get_bd_pins vio_rgpio/probe_in7]
  connect_bd_net -net vio_rgpio_m_17_S5_3_USER [get_bd_pins xlslice_6/Dout] [get_bd_pins vio_rgpio/probe_in6]
  connect_bd_net -net vio_rgpio_m_18_S5_4_FMCVADJ [get_bd_pins xlslice_5/Dout] [get_bd_pins vio_rgpio/probe_in5]
  connect_bd_net -net vio_rgpio_m_19_reserved [get_bd_pins xlslice_4/Dout] [get_bd_pins vio_rgpio/probe_in4]
  connect_bd_net -net vio_rgpio_m_20_SD_WP [get_bd_pins xlslice_3/Dout] [get_bd_pins vio_rgpio/probe_in3]
  connect_bd_net -net vio_rgpio_m_21_FMC_CLKDIR [get_bd_pins xlslice_2/Dout] [get_bd_pins vio_rgpio/probe_in2]
  connect_bd_net -net vio_rgpio_m_22_PJTAG_TRST [get_bd_pins xlslice_1/Dout] [get_bd_pins vio_rgpio/probe_in1]
  connect_bd_net -net vio_rgpio_m_23_PJTAG_SRST [get_bd_pins xlslice_0/Dout] [get_bd_pins vio_rgpio/probe_in0]
  ...
  connect_bd_net -net vio_rgpio_m_7dt0_data [get_bd_pins xlslice_11/Dout] [get_bd_pins vio_rgpio/probe_in11]
  connect_bd_net -net vio_rgpio_m_7dt6_unused [get_bd_pins vio_rgpio/probe_out4] [get_bd_pins xlconcat_2/In1]
  connect_bd_net -net vio_rgpio_m_enable [get_bd_pins vio_rgpio/probe_out0] [get_bd_pins RGPIO_Master_CPLD/RGPIO_M_ENABLE]
  connect_bd_net -net vio_rgpio_s_0_S5_1_bootmode [get_bd_pins xlslice_19/Dout] [get_bd_pins vio_rgpio/probe_in19]
  connect_bd_net -net vio_rgpio_s_11dt8_bootmode [get_bd_pins xlslice_13/Dout] [get_bd_pins vio_rgpio/probe_in13]
  connect_bd_net -net vio_rgpio_s_1_S5_2_bootmode [get_bd_pins xlslice_18/Dout] [get_bd_pins vio_rgpio/probe_in18]
  connect_bd_net -net vio_rgpio_s_23dt12_PG [get_bd_pins xlslice_12/Dout] [get_bd_pins vio_rgpio/probe_in12]
  connect_bd_net -net vio_rgpio_s_23dt8_unused [get_bd_pins vio_rgpio/probe_out6] [get_bd_pins xlconcat_3/In1]
  connect_bd_net -net vio_rgpio_s_2_xmod1_button [get_bd_pins xlslice_17/Dout] [get_bd_pins vio_rgpio/probe_in17]
  connect_bd_net -net vio_rgpio_s_3_unused [get_bd_pins xlslice_16/Dout] [get_bd_pins vio_rgpio/probe_in16]
  connect_bd_net -net vio_rgpio_s_6dt5_SD_CD [get_bd_pins xlslice_15/Dout] [get_bd_pins vio_rgpio/probe_in15]
  connect_bd_net -net vio_rgpio_s_7dt0_data [get_bd_pins vio_rgpio/probe_out7] [get_bd_pins xlconcat_3/In0]
  connect_bd_net -net vio_rgpio_s_7dt6_ER_ERST [get_bd_pins xlslice_14/Dout] [get_bd_pins vio_rgpio/probe_in14]
  connect_bd_net -net vio_rgpio_s_enable [get_bd_pins vio_rgpio/probe_out1] [get_bd_pins RGPIO_Slave_CPLD/RGPIO_M_ENABLE]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins xlconcat_2/dout] [get_bd_pins RGPIO_Master_CPLD/RGPIO_M_IN]
  connect_bd_net -net xlconcat_3_dout [get_bd_pins xlconcat_3/dout] [get_bd_pins RGPIO_Slave_CPLD/RGPIO_M_IN]
...
proc create_hier_cell_LOKI_Control { parentCell nameHier } {
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins loki_ctrl_i]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_pins CTRL1_lc5]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins xlslice_1/Dout] [get_bd_pins APP_PER_NRST_lc6]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins xlslice_2/Dout] [get_bd_pins APP_NRST_lc7]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins xlslice_3/Dout] [get_bd_pins CLKGEN_NRST_lc8]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins xlslice_4/Dout] [get_bd_pins CLKGEN_AC_lc9_11]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins xlslice_5/Dout] [get_bd_pins TEMP_NRST_lc12]
  connect_bd_net -net xlslice_8_Dout [get_bd_pins xlslice_8/Dout] [get_bd_pins ULED_lc13_16]
...
proc create_hier_cell_GPIO_Tree { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_GPIO_Tree() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: xlslice_emio1_11_out1, and set properties
  set xlslice_emio1_11_out1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xlslice_emio1_11_out1 ]
  set_property -dict [list \
    CONFIG.DIN_FROM {31} \
    CONFIG.DIN_TO {21} \
    CONFIG.DIN_WIDTH {95} \
    CONFIG.DOUT_WIDTH {11} \
  ] $xlslice_emio1_11_out1
  ...
  # Create instance: xlslice_emio1_11_tri1, and set properties
  set xlslice_emio1_11_tri1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xlslice_emio1_11_tri1 ]
  set_property -dict [list \
    CONFIG.DIN_FROM {20} \
    CONFIG.DIN_TO {17} \
    CONFIG.DIN_WIDTH {95} \
    CONFIG.DOUT_WIDTH {4} \
  ] $xlslice_emio1_11_tri1


  # Create instance: xlslice_emio1_11_tri2, and set properties
  set xlslice_emio1_11_tri2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xlslice_emio1_11_tri2 ]
  set_property -dict [list \
    CONFIG.DIN_FROM {31} \
    CONFIG.DIN_TO {21} \
    CONFIG.DIN_WIDTH {95} \
    CONFIG.DOUT_WIDTH {11} \
  ] $xlslice_emio1_11_tri2
  ...
  connect_bd_net -net xlconcat_emio1_11_in_dout [get_bd_pins xlconcat_emio1_11_in/dout] [get_bd_pins dout_0]
  connect_bd_net -net xlslice_emio0_out_Dout [get_bd_pins xlslice_emio0_out/Dout] [get_bd_pins ubuff_lvds_emio_0/IOBUF_IO_I]
  connect_bd_net -net xlslice_emio1_11_out1_Dout [get_bd_pins xlslice_emio1_11_out1/Dout] [get_bd_pins iobuff_emio_1_12/IOBUF_IO_I]
  connect_bd_net -net xlslice_emio1_11_out2_Dout [get_bd_pins xlslice_emio1_11_out2/Dout] [get_bd_pins GPIO_APP_o]
  connect_bd_net -net xlslice_emio1_11_out_Dout [get_bd_pins xlslice_emio1_11_out/Dout] [get_bd_pins loki_ctrl_o_0_16]
  connect_bd_net -net xlslice_emio1_11_tri1_Dout [get_bd_pins xlslice_emio1_11_tri1/Dout] [get_bd_pins ubuff_lvds_emio_0/IOBUF_IO_T]
  connect_bd_net -net xlslice_emio1_11_tri2_Dout [get_bd_pins xlslice_emio1_11_tri2/Dout] [get_bd_pins iobuff_emio_1_12/IOBUF_IO_T]
  connect_bd_net -net xlslice_emio1_11_tri3_Dout [get_bd_pins xlslice_emio1_11_tri3/Dout] [get_bd_pins GPIO_APP_t]
  connect_bd_net -net xlslice_emio1_11_tri_Dout [get_bd_pins xlslice_emio1_11_tri/Dout] [get_bd_pins loki_ctrl_t_0_16]
...
SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO0 MIO#GPIO0 MIO#SPI 0#SPI 0#SPI 0#SPI 0#SPI 0#SPI 0#SPI 1#SPI 1#SPI 1#SPI 1#SPI 1#SPI 1#I2C 0#I2C 0#I2C 1#I2C 1#UART\
0#UART 0#SD 1##SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO\
3} \
    CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#clk_for_lpbk#n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow#gpio0[24]#gpio0[25]#sclk_out#n_ss_out[2]#n_ss_out[1]#n_ss_out[0]#miso#mosi#sclk_out#n_ss_out[2]#n_ss_out[1]#n_ss_out[0]#miso#mosi#scl_out#sda_out#scl_out#sda_out#rxd#txd#sdio1_wp##sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out}\
\
    ...
    CONFIG.PSU__CRL_APB__SDIO1_REF_CTRL__ACT_FREQMHZ {99.999985} \
...
\
    ...
    CONFIG.PSU__SPI0__GRP_SS1__IO {MIO 28} \
    CONFIG.PSU__SPI0__GRP_SS2__ENABLE {1} \
    CONFIG.PSU__SPI0__GRP_SS2__IO {MIO 27} \
  ...
  connect_bd_net -net LOKI_Control_APP_NRST_lc7 [get_bd_pins LOKI_Control/APP_NRST_lc7] [get_bd_ports APP_NRST_lc7]
  connect_bd_net -net LOKI_Control_APP_PER_NRST_lc6 [get_bd_pins LOKI_Control/APP_PER_NRST_lc6] [get_bd_ports APP_PER_NRST_lc6]
  connect_bd_net -net LOKI_Control_CLKGEN_AC_lc9_11 [get_bd_pins LOKI_Control/CLKGEN_AC_lc9_11] [get_bd_ports CLKGEN_AC_lc9_11]
  connect_bd_net -net LOKI_Control_CLKGEN_NRST_lc8 [get_bd_pins LOKI_Control/CLKGEN_NRST_lc8] [get_bd_ports CLKGEN_NRST_lc8]
  connect_bd_net -net LOKI_Control_CTRL1_0_lc5 [get_bd_pins LOKI_Control/CTRL1_lc5] [get_bd_ports CTRL1_lc5]
  connect_bd_net -net LOKI_Control_TEMP_NRST_lc12 [get_bd_pins LOKI_Control/TEMP_NRST_lc12] [get_bd_ports TEMP_NRST_lc12]
  connect_bd_net -net LOKI_Control_ULED_lc13_16 [get_bd_pins LOKI_Control/ULED_lc13_16] [get_bd_ports ULED_lc13_16]
  ...
  connect_bd_net -net loki_ctrl_i_0_16_1 [get_bd_pins LOKI_Control/loki_ctrl_i] [get_bd_pins GPIO_Tree/loki_ctrl_i_0_16]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins RGPIO/RGPIO_M_RESET_N]
  connect_bd_net -net vio_CAN_0_S [get_bd_pins vio_general/probe_out2] [get_bd_pins SC0808BF_0/CAN_S]
  connect_bd_net -net vio_LED_HD [get_bd_pins vio_general/probe_out0] [get_bd_pins SC0808BF_0/LED_HD]
  connect_bd_net -net vio_LED_XMOD2 [get_bd_pins vio_general/probe_out1] [get_bd_pins SC0808BF_0/LED_XMOD2]
  connect_bd_net -net zynq_ultra_ps_e_0_dp_audio_ref_clk [get_bd_pins zynq_ultra_ps_e_0/dp_audio_ref_clk] [get_bd_pins axis_live_audio_0/axis_aclk] [get_bd_pins zynq_ultra_ps_e_0/dp_s_axis_audio_clk]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o] [get_bd_pins GPIO_Tree/din]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_t [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_t] [get_bd_pins GPIO_Tree/tri_in]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk1] [get_bd_pins RGPIO/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk1 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins RGPIO/clk1] [get_bd_pins vio_general/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk]
