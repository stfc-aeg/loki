...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SPI0_REF_CTRL_DIVISOR1                          0xf

    * 6 bit divider
    *  PSU_CRL_APB_SPI0_REF_CTRL_DIVISOR0                          0x32
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E007C, 0x013F3F07U ,0x010F3202U)
    */
	PSU_Mask_Write(CRL_APB_SPI0_REF_CTRL_OFFSET,
		0x013F3F07U, 0x010F3202U);
/*##################################################################### */
