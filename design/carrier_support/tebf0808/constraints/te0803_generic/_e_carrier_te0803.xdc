...
set_property PACKAGE_PIN E7 [get_ports {GPIO_APP_21_31[1]} ]
set_property PACKAGE_PIN D2 [get_ports {GPIO_APP_21_31[2]} ]
set_property PACKAGE_PIN G4 [get_ports {GPIO_APP_21_31[3]} ]
set_property PACKAGE_PIN K5 [get_ports {GPIO_APP_21_31[4]} ]
set_property PACKAGE_PIN P9 [get_ports {GPIO_APP_21_31[5]} ]
set_property PACKAGE_PIN H2 [get_ports {GPIO_APP_21_31[6]} ]
set_property PACKAGE_PIN W9 [get_ports {GPIO_APP_21_31[7]} ]
set_property PACKAGE_PIN AH10 [get_ports {GPIO_APP_21_31[8]} ]
set_property PACKAGE_PIN AF11 [get_ports {GPIO_APP_21_31[9]} ]
set_property PACKAGE_PIN AD11 [get_ports {GPIO_APP_21_31[10]} ]
...
set_property PACKAGE_PIN R6 [get_ports {GPIO_LVDS_P_17_20[1]} ]
set_property PACKAGE_PIN T6 [get_ports {GPIO_LVDS_N_17_20[1]} ]
set_property IOSTANDARD LVDS [get_ports {GPIO_LVDS_P_17_20[1]} ]
set_property IOSTANDARD LVDS [get_ports {GPIO_LVDS_N_17_20[1]} ]

set_property PACKAGE_PIN R7 [get_ports {GPIO_LVDS_P_17_20[2]} ]
set_property PACKAGE_PIN T7 [get_ports {GPIO_LVDS_N_17_20[2]} ]
set_property IOSTANDARD LVDS [get_ports {GPIO_LVDS_P_17_20[2]} ]
set_property IOSTANDARD LVDS [get_ports {GPIO_LVDS_N_17_20[2]} ]

set_property PACKAGE_PIN R8 [get_ports {GPIO_LVDS_P_17_20[3]} ]
set_property PACKAGE_PIN T8 [get_ports {GPIO_LVDS_N_17_20[3]} ]
